...
with open("input") as fp:
    ...
    while True:
        ...
        try:
            crate_stacks[matched_line[2] - 1] = crate_stacks[matched_line[1] - 1][0:matched_line[0]] + crate_stacks[matched_line[2] - 1]
            crate_stacks[matched_line[1] - 1] = crate_stacks[matched_line[1] - 1][matched_line[0]:]
        except IndexError:
            pass  
